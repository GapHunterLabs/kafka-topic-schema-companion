package dev.gaphunter.kafkatopicschemacompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.kafkatopicschemacompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.kafkatopicschemacompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Kafka Topic Schema Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33887-kafka-topic-schema-companion/reviews"
